...
import org.kodigo.codemasters.oauth2.CustomOAuth2UserService;
import org.kodigo.codemasters.oauth2.CustomOidcUserService;
import org.kodigo.codemasters.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().and().formLogin()//
				...
				.passwordParameter("j_password").and().oauth2Login().loginPage("/login").failureHandler(authenticationFailureHandler).defaultSuccessUrl("/success").userInfoEndpoint()
